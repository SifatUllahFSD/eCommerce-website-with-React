...
useEffect(() => {
    axios
      ...
      .then(res => {
            ...
            setCateProducts(filteredProducts)
        })
  ...
  return (
   <>
   <section className='pb-[168px] pt-[100px]'>
    <div className="container">
        <div className="">
             <h4 className='font-poppins font-semibold text-[16px] text-[#DB4444] leading-5 pl-9 relative after:absolute after:w-5 after:h-10 after:bg-[#DB4444] after:content-[""] after:left-0 after:-top-[50%] after:rounded-sm '>Category</h4>
           <div className="flex justify-between items-center text-center "> 
            <h2 className='pt-[34px] font-inter font-semibold text-[36px]  text-[#ff003cde] leading-8 '>{keyword} </h2>
        ...
        <div className=" grid grid-cols-4 pt-[60px] gap-x-[30px] gap-y-[60px] pb-[60px] ">
             {
               ...
               <h3 className='pt-4 font-poppins font-medium text-[16px] leading-6 text-[#000000] '>{product.title}</h3>
                <div className="flex gap-2 items-center ">
                      <p className='pt-2 text-[#DB4444] font-poppins font-medium text-[16px] leading-6 flex gap-3'><Link to="/product/details">{product.title}</Link></p>
